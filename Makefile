all: DIS_ASM/DIS_ASM.cpp DIS_ASM/main.cpp ASM/ASM.cpp ASM/main.cpp CPU/CPU.cpp CPU/main.cpp FileProcessing/FileProcessing.cpp Stack/stack_common.cpp Stack/stack.cpp
	g++ ASM/ASM.cpp ASM/main.cpp FileProcessing/FileProcessing.cpp -o MY_ASM
...
ASM: ASM/ASM.cpp ASM/main.cpp FileProcessing/FileProcessing.cpp
	g++ ASM/ASM.cpp ASM/main.cpp FileProcessing/FileProcessing.cpp -o MY_ASM
